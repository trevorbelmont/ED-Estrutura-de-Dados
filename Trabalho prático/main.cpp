...
int main() {
  ...
  try {
    ...
    cout << "Avaliação Infixa 1 = " << fixed << setprecision(6) << solvePostfix(f) << endl;
    ...
    cout << "Avaliação pósfixa 2 = " << solvePostfix(f) << endl;
    ...
    cout << "Avaliação Infixa 2 = " << fixed << setprecision(6) << solvePostfix(f) << endl;
  } catch (error e) {
    cout << e.message << endl;
  }
  return 0;
